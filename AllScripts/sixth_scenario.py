...
sim_tim = 1000
t0 = 0;
x0 = np.array([[+0.866], [+0.5], [-2.618], [+0.0], [+1.0], [-1.57], [-0.866], [0.5], [-0.523],\
 [-0.866], [-0.5], [0.523], [0.0], [-1.0], [1.57], [+0.866], [-0.5], [+2.618]])
Xr1 = np.array([[+0.866], [+0.5], [-2.618]])
Xr2 = np.array([[+0.0], [+1.0], [-1.57]])                                                            # initial condition.
Xr3 = np.array([[-0.866], [+0.5], [-0.523]])
Xr4 = np.array([[-0.866], [-0.5], [+0.523]])                                                            # initial condition.
Xr5 = np.array([[0.0], [-1.0], [1.57]])
Xr6 = np.array([[0.866], [-0.5], [2.618]])
...
# print("x0: ", x0)
# Reference point
xs = np.array([[-0.866], [-0.5], [-2.618], [+0.0], [-1.0], [-1.57], [+0.866], [-0.5], [-0.523],\
 [+0.866], [+0.5], [+0.523], [0.0], [+1.0], [1.57] ,\
 [-0.866], [+0.5], [2.618]])                                                        # Reference posture.
