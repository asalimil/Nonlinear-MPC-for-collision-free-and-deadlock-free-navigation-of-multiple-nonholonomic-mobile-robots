...
# print("x0: ", x0)
xs = np.array([[+2.5], [2.0], [1.57]])                                                        # Reference posture.
...
# main_loop = tic;
#
while (LA.norm(x0-xs) > 5e-2) and (mpciter < sim_tim / T) and (not rospy.is_shutdown()):
    ...
    # t0 = shiftout[0]; x0 = shiftout[1]; u0 = shiftout[2]
