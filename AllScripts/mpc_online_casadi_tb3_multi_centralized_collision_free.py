...
sim_tim = 1000
t0 = 0;
x0 = np.array([[-1.0], [+1.0], [-0.785], [+1.0], [+1.0], [-2.356], [+1.0], [-1.0], [+2.356], [-1.0], [-1.0], [0.785], [0.0], [0.0], [0.0]])
Xr1 = np.array([[-1.0], [+1.0], [-0.785]])
...
# print("x0: ", x0)
xs = np.array([[+1.0], [-1.0], [-0.785], [-1.0], [-1.0], [-2.356], [-1.0], [+1.0], [+2.356], [+1.0], [+1.0], [+0.785], [+0.0], [+0.0], [0.0]])                                                        # Reference posture.
...
while (LA.norm(x0-xs) > 1e-1) and (not rospy.is_shutdown()):
 # and (mpciter < sim_tim / T)
    ...
    print("v1, w1, v2, w2, v3, v4, v5, w5: ", u_cl[mpciter,0], u_cl[mpciter,1], u_cl[mpciter,2], u_cl[mpciter,3], u_cl[mpciter,4], u_cl[mpciter,5], u_cl[mpciter,6], u_cl[mpciter,7], u_cl[mpciter,8], u_cl[mpciter,9])
