...
args = {'lbg': np.concatenate((np.array([[0.0],[0.0],[0.0]]), np.matlib.repmat(np.array([[0.0],[0.0],[0.0],[0.05]]),N,1)), axis=0), 'ubg': np.concatenate((np.array([[0.0],[0.0],[0.0]]), np.matlib.repmat(np.array([[0.0],[0.0],[0.0],[np.Inf]]),N,1)), axis=0), \
