...
Xr1_init = np.array([[+0.0], [-0.7112], [1.57]])
Xr2_init = np.array([[-0.5588], [-0.7112], [1.57]])
Xr3_init = np.array([[-1.176], [-0.7112], [1.57]])
...
# print("x0: ", x0)
xs = np.array([[+1.176], [-0.3556], [0.0], [+1.176], [0.0], [0.0], [+1.176], [0.3556], [0.0]])                                                                                     # Reference posture.
