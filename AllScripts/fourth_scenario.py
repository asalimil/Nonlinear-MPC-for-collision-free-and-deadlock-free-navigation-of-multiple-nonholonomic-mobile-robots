...
sim_tim = 1000
t0 = 0;
x0 = np.array([[-1.0], [+1.0], [-0.785], [+1.0], [+1.0], [-2.356], [-1.0], [-1.0], [+0.785], [+1.0], [-1.0], [+2.356]])
Xr1 = np.array([[-1.0], [+1.0], [-0.785]])
Xr2 = np.array([[+1.0], [+1.0], [-2.356]])                                                            # initial condition.
Xr3 = np.array([[-1.0], [-1.0], [+0.785]])
Xr4 = np.array([[+1.0], [-1.0], [+2.356]])                                                            # initial condition.
...
# print("x0: ", x0)
xs = np.array([[1.0], [-1.0], [-0.785], [-1.0], [-1.0], [-2.356], [+1.0], [+1.0], [+0.785], [-1.0], [+1.0], [+2.356]])                                                        # Reference posture.
