...
sim_tim = 1000
t0 = 0;
x0 = np.array([[-0.5], [+1.0], [0.0], [-1.0], [+0.5], [0.0], [-1.5], [0.0], [+0.0], \
[-1.0], [-0.5], [0.0], [-0.5], [-1.0], [0.0]])
Xr1 = np.array([[-0.5], [+1.0], [0.0]])
Xr2 = np.array([[-1.0], [+0.5], [0.0]])                                                            # initial condition.
Xr3 = np.array([[-1.5], [0.0], [0.0]])
Xr4 = np.array([[-1.0], [-0.5], [0.0]])                                                            # initial condition.
Xr5 = np.array([[-0.5], [-1.0], [0.0]])
...
# print("x0: ", x0)
xs = np.array([[+0.5], [-1.0], [0.0], [+1.0], [-0.5], [0.0], [+1.5], [0.0], [0.0], \
[+1.0], [+0.5], [+0.0], [+0.5], [+1.0], [0.0]])                                                        # Reference posture.
