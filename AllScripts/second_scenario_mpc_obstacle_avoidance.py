...
omega_max = +math.pi/4; omega_min = -omega_max
...
obs3_y = -1.25
#
obs4_r = 0.125   # obstacle's diameter
obs4_x = 0.0
obs4_y = 1.0
...
args = {'lbg': np.concatenate((np.array([[0.0],[0.0],[0.0]]), np.matlib.repmat(np.array([[0.0],[0.0],[0.0],[0.05],[0.05],[0.05],[0.05]]),N,1)), axis=0), 'ubg': np.concatenate((np.array([[0.0],[0.0],[0.0]]), np.matlib.repmat(np.array([[0.0],[0.0],[0.0],[np.Inf],[np.Inf],[np.Inf],[np.Inf]]),N,1)), axis=0), \
...
while (not rospy.is_shutdown()):
 # and (mpciter < sim_tim / T)
    ...
    if goal_idx == 1:
        ...
        xs = np.array([[0.5], [0.0], [-1.57]]) # reference pose
    elif goal_idx == 3:
        xs = np.array([[-0.5], [+1.5], [3.14]]) # reference pose
    elif goal_idx == 4:
        xs = np.array([[-1.0], [-0.75], [+0.785]]) # reference pose
    elif goal_idx == 5:
        xs = np.array([[0.5], [-2.0], [-0.785]]) # reference pose
    elif goal_idx == 6:
